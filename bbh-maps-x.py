...
def plot_physical(numrel_data, iota, phi, show_plot=True):
...
def plot_geometric(numrel_data, iota, phi, show_plot=True):
...
def gen_one_map(iota, phi, numrel_data):
	...
	tf_decompose()
	plot_physical(numrel_data, iota, phi, show_plot=False)
	plot_geometric(numrel_data, iota, phi, show_plot=False)
...
iota_start, iota_end, iota_step = pi/2, pi/2, 0
phi_start, phi_end, phi_step = 0, 2*pi, pi

gen_maps(iota_start, iota_end, iota_step, phi_start, phi_end, phi_step)
