...
def check_step(start, end, step, var_name, bound=None):
    print var_name, ": ", start, end, step, bound
    ...
    if bound != None:
        if end > bound:
            raise Exception("End value of {} cannot be larger than {}."
                .format(var_name, bound))
...
parser.add_argument("savepath", help="the absolute path for the directory where the \
